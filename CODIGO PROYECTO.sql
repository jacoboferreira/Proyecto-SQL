...
SELECT round(variance("replacement_cost"), 2) AS "Varianza del coste"
FROM "film";
...
SELECT AVG("rental_duration") AS "Media del aqluiler"
FROM "film";
...
ORDER BY "Precio Promedio Alquiler" ;
...
SELECT i."film_id" AS "id_pelicula",
...
CREATE TEMPORARY TABLE "cliente_rentas_tempora" AS 
SELECT concat(a."first_name", ' ', a."last_name") AS "nombre actor",
        count(fa."film_id")
FROM "actor" a
JOIN "film_actor" AS fa
